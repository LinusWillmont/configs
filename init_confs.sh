...
place_config "ghostty.conf" "$HOME_DIR/.config/ghostty/config"
place_config "nvim" "$HOME_DIR/.config/nvim"
place_config "bash/bash_aliases" "$HOME_DIR/.bash_aliases"
place_config "bash/bash_path" "$HOME_DIR/.bashrc.d/bash_path"
place_config "bash/bash_kube" "$HOME_DIR/.bashrc.d/bash_kube"
place_config "bash/bash_prompt" "$HOME_DIR/.bashrc.d/bash_prompt"
place_config "bash/bash_history" "$HOME_DIR/.bashrc.d/bash_history"
